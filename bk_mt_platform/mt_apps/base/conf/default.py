...
INSTALLED_APPS += (
    'rest_framework',
    'mt_apps.base.permission',
    'mt_apps.base.system_config',
    'mt_apps.base.task',
    'mt_apps.base.audit',
    'mt_apps.base.audit.auditlog',
    'mt_apps.base.notify_manage',
)
...
MIDDLEWARE += (
    ...
    'mt_apps.base.audit.auditlog.middleware.ThreadLocalMiddleware',
)

# REST配置
# Postman测试使用：Django REST framework的默认认证模式（配置不正确页面会出现{"detail":"CSRF Failed: CSRF token missing or incorrect."}）
REST_FRAMEWORK = {
    'EXCEPTION_HANDLER': 'mt_apps.base.app_fw.exception_handler.exception_handler',
...
CELERY_IMPORTS = (
    'mt_apps.base.task.celery_tasks',
)
