...
if ENVIRONMENT != 'dev':
    if os.getenv('BK_PAAS_HOST') == 'https://paas.bk.moonton.net:443':
        ENVIRONMENT = 'formal_' + ENVIRONMENT
    elif os.getenv('BK_PAAS_HOST') == 'http://paas.bk.oa.mt:80':
        ENVIRONMENT = 'test_' + ENVIRONMENT

DJANGO_CONF_MODULE = 'conf.{env}'.format(env=ENVIRONMENT)
