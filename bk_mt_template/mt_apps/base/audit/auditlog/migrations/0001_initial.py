    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('biz_id', models.IntegerField(blank=True, default=0, null=True)),
                ...
                ('actor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                            related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='actor')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+',
